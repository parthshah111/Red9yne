...
//    public List<MenuTotalEntity> menuTotalEntities;
//    @OneToMany(fetch = FetchType.EAGER, mappedBy = "foodEntity", cascade = CascadeType.ALL)
//    public List<MenuTotalEntity> getMenuTotalEntities() {
//        return menuTotalEntities;
//    }
//
//    public void setMenuTotalEntities(List<MenuTotalEntity> menuTotalEntities) {
//        this.menuTotalEntities = menuTotalEntities;
//    }
//
//
//
