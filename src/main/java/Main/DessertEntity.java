...
@Entity
@Table(name = "Dessert", schema = "dbo", catalog = "DBdummy3")
public class DessertEntity {
    private int dessertId;
    private String dessertName;
    private String dessertDesc;
    private double dessertPrice;
    private List<DessertMenuEntity> dessertMenuEntities;

    @OneToMany(fetch = FetchType.EAGER, mappedBy = "dessertEntity", cascade = CascadeType.ALL)
    public List<DessertMenuEntity> getDessertMenuEntities() {
        return dessertMenuEntities;
    }

    public void setDessertMenuEntities(List<DessertMenuEntity> dessertMenuEntities) {
        this.dessertMenuEntities = dessertMenuEntities;
    }
